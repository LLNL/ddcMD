...
CFLAGS_BASE =  -DWITH_MPI -DWITH_PIO -D_GNU_SOURCE -Wall -Wextra -Wno-unused-parameter \
              -Wno-unknown-pragmas
#GNU Compiler
FFTW_DIR=/autofs/nccs-svm1_sw/summit/.swci/1-compute/opt/spack/20180914/linux-rhel7-ppc64le/xl-16.1.1-4/fftw-3.3.8-47bi2nrryanhwf33hk2lsqdkrikoqkk2/lib/
LDFLAGS_BASE =  -lstdc++ -lm -lc $(FFTW_DIR)/libfftw3.a -L $(CPPL)
#XL Compiler
...
ifeq ($(USE_GPU),1)
  ...
  NVCCFLAGS_BASE += -DUSE_GPU=1 -I ../cub --gpu-architecture=sm_70 -I/usr/local/tools/mvapich-gnu/include -I/autofs/nccs-svm1_sw/summit/.swci/1-compute/opt/spack/20180914/linux-rhel7-ppc64le/xl-16.1.1-4/spectrum-mpi-10.3.0.1-20190611-o4gg2apgfflunavcrlh2izdrrclyynlu/include
