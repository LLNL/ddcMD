...
CPPL = /usr/tce/packages/xl/xl-beta-2018.06.01/lib/
...
CFLAGS_BASE =  -DWITH_MPI -DWITH_PIO -D_GNU_SOURCE -Wall -Wextra -Wno-unused-parameter \
              -Wno-unknown-pragmas
#GNU Compiler
LDFLAGS_BASE =  -lstdc++ -lm -lc /usr/tcetmp/packages/fftw/fftw-3.3.5-xl-beta-2017.04.11/lib/libfftw3.a -L $(CPPL)
#XL Compiler
...
USE_GPU = 1
ifeq ($(USE_GPU),1)
  #CUDAHOME=/usr/tce/packages/cuda/cuda-9.2.88/
  ...
  NVCCFLAGS_BASE += -DUSE_GPU=1 -I ../cub --gpu-architecture=sm_70 -I/usr/local/tools/mvapich-gnu/include -I /usr/tce/packages/spectrum-mpi/ibm/spectrum-mpi-2018.06.01/include
